...
/* 29 */
EXTERN Tcl_Obj *        Tcl_NewVlogObj _ANSI_ARGS_((long size, unsigned int *value,
                            int copy));
/*30 */
EXTERN Tcl_Obj *        Tcl_NewVhdlObj _ANSI_ARGS_((long *ptr1, long *ptr2,
                            int copy));
...
EXTERN char *           Tcl_GetStringAtlast _ANSI_ARGS_((Tcl_Obj * objPtr,
                                int * lengthPtr));
...
EXTERN void		Tcl_SetLongObj _ANSI_ARGS_((Tcl_Obj * objPtr, 
				long longValue));
/* 64 */
EXTERN void             Tcl_SetVhdlObj _ANSI_ARGS_((Tcl_Obj *objPtr,
                            long *ptr1, long *ptr2));
EXTERN void             Tcl_SetVlogObj _ANSI_ARGS_((Tcl_Obj *objPtr,
                            long size, unsigned int *value));
EXTERN int              Tcl_VlogGetInt _ANSI_ARGS_((Tcl_Obj *objPtr));
EXTERN double           Tcl_VlogGetDouble _ANSI_ARGS_((Tcl_Obj *objPtr));
EXTERN int              Tcl_VlogIsTrue _ANSI_ARGS_((Tcl_Obj *objPtr));
...
EXTERN void		Tcl_WrongNumArgs _ANSI_ARGS_((Tcl_Interp * interp, 
				int objc, Tcl_Obj *CONST objv[], 
				CONST char * message));
EXTERN void             Tcl_SetVbitsFormat _ANSI_ARGS_((int format));
EXTERN char *           Tcl_SetCbkVar _ANSI_ARGS_(( Tcl_Interp *interp,
                            char *varName, char *newValue, int flags));
EXTERN void             Tcl_TraverseVars _ANSI_ARGS_(( Tcl_Interp *interp,
                            void (*cbk)(), Tcl_VarTraceProc *proc));
EXTERN void             Tcl_SetVarCreateCbk _ANSI_ARGS_(( Tcl_Interp *interp,
                            void (*cbk)()));
EXTERN int              Tcl_LiteralDouble _ANSI_ARGS_(( Tcl_Interp *interp,
                            char *string, char **term, double *ptr));
EXTERN int              Tcl_LiteralLong _ANSI_ARGS_(( Tcl_Interp *interp,
                            char *string, char **term, long *ptr));
EXTERN int              Tcl_LiteralVbits _ANSI_ARGS_(( Tcl_Interp *interp,
                            char *string, char **term, long **ptr, long *size));
...
EXTERN int		Tcl_DisableNcsimSyntax _ANSI_ARGS_((
				Tcl_Interp * interp));
/* Slot 495 is reserved */
EXTERN int		Tcl_EnableNcsimSyntax _ANSI_ARGS_((
				Tcl_Interp * interp));
...
/* Custom: Added by Cadence */
EXTERN void Tcl_RunIdleNow _ANSI_ARGS_((ClientData clientData));
...
/*    void *reserved494; */
    int	(*Tcl_DisableNcsimSyntax) _ANSI_ARGS_ (( Tcl_Interp * interp));
    int	(*Tcl_EnableNcsimSyntax) _ANSI_ARGS_ (( Tcl_Interp * interp));
    void *reserved496;
    void *reserved497;
    void *reserved498;
    void *reserved499;
...
#endif
/* Slot 494 is reserved */
#ifndef Tcl_DisableNcsimSyntax
#define Tcl_DisableNcsimSyntax\
	(tclStubsPtr->Tcl_DisableNcsimSyntax) /* 494 */
#endif
/* Slot 495 is reserved */
#ifndef Tcl_EnableNcsimSyntax 
#define Tcl_EnableNcsimSyntax\
	(tclStubsPtr->Tcl_EnableNcsimSyntax) /* 494 */
#endif
/* Slot 496 is reserved */
/* Slot 497 is reserved */
/* Slot 498 is reserved */
